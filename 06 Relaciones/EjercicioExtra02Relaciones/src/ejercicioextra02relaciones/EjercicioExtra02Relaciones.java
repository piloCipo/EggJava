 ...
 */
package ejercicioextra02relaciones;
 ...
 * @author pilo
 */
public class EjercicioExtra02Relaciones {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        Pelicula pelicula= new Pelicula("La Monja", 2.3, 16, "Nose");
        Cine cine = new Cine(pelicula, 50);
        cine.mostrarSala();
        
        while (cine.asientoDisponible()) {            
            ...
            boolean asientoAsignado = cine.ubicarEspectador(espectador);
            if (asientoAsignado) {
                System.out.println("¡Asiento asignado con éxito!");
            } else {
                System.out.println("No se pudo asignar un asiento para el espectador.");
            }
            cine.mostrarSala();
        }
